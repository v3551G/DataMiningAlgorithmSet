...
public class Client {
	public static void main(String[] args){
		...
		//测试数据文件地址
		String filePath = "G:\\softWork\\eclipseWorkstation\\DataMiningAlgorithm\\Others\\DataMining_MSApriori\\input.txt";
		//关系表型数据文件地址
		String tableFilePath = "G:\\softWork\\eclipseWorkstation\\DataMiningAlgorithm\\Others\\DataMining_MSApriori\\input2.txt";
		//最小支持度阈值
		double minSup;
		// 最小置信度率
		double minConf;
